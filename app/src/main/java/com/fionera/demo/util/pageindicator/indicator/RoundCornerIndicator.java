...
public class RoundCornerIndicator
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int verticalOffset = getPaddingTop() + (getHeight() - getPaddingTop() - getPaddingBottom
                ()) / 2 - indicatorHeight / 2;
        int indicatorLayoutWidth = indicatorWidth * count + indicatorGap * (count - 1);
        int horizontalOffset = getPaddingLeft() + (getWidth() - getPaddingLeft() -
                getPaddingRight()) / 2 - indicatorLayoutWidth / 2;
