...
public class PullToRefreshLayout
    ...
    Handler updateHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            MOVE_SPEED = (float) (8 + 5 * Math
                    .tan(Math.PI / 2 / getMeasuredHeight() * (pullDownY + Math.abs(pullUpY))));
            if (!isTouch) {
    ...
    private void initView(Context context) {
        ...
        refreshingAnimation = (RotateAnimation) AnimationUtils
                .loadAnimation(context, R.anim.rotate_pull_arrow);
        // 添加匀速转动动画
    ...
    public void refreshFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                refreshStateImageView.setBackgroundResource(R.drawable.iv_refresh_succeed);
                break;
            case FAIL:
            default:
                // 刷新失败
                ...
                refreshStateImageView.setBackgroundResource(R.drawable.iv_refresh_failed);
                break;
        }
        if (pullDownY > 0) {
            // 刷新结果停留1秒
    ...
    public void loadmoreFinish(int refreshResult) {
        ...
        switch (refreshResult) {
            case SUCCEED:
                ...
                loadStateImageView.setBackgroundResource(R.drawable.iv_load_succeed);
                break;
            case FAIL:
            default:
                // 加载失败
                ...
                loadStateImageView.setBackgroundResource(R.drawable.iv_load_failed);
                break;
        }
        if (pullUpY < 0) {
            // 刷新结果停留1秒
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        loadmoreView.layout(0, (int) (pullDownY + pullUpY) + pullableView.getMeasuredHeight(),
                            ...
                            (int) (pullDownY + pullUpY) + pullableView
