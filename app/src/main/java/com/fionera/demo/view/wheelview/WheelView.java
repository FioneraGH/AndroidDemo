...
public class WheelView extends View {
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.bg_white_corner0;
    private int wheelForeground = R.drawable.bg_white_yellow1_corner5;
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        // 设置线宽
        paint.setStrokeWidth((float) DisplayUtils.dp2px(1));
        // 绘制上边直线
        canvas.drawLine(PADDING, center - offset, getWidth() - PADDING, center - offset, paint);
        // 绘制下边直线
        canvas.drawLine(PADDING, center + offset, getWidth() - PADDING, center + offset, paint);
        // 绘制左边直线
        canvas.drawLine(PADDING, center - offset, PADDING, center + offset, paint);
        // 绘制右边直线
        canvas.drawLine(getWidth() - PADDING, center - offset, getWidth() - PADDING, center + offset, paint);
    }
